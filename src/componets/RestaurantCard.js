...
const RestaurantCard = (props) => {
  ...
  const { name, avgRating, sla, cuisines, areaName, cloudinaryImageId } =
    resData.info;
  return (
    <div data-testid="restaurant-card" className="w-[250] mt-2 p-4 bg-gray-50 hover:shadow-lg">
      <img className="rounded-md h-[170px] w-[240px]" src={CDN_URL + cloudinaryImageId} />
      <div className="mt-2">
